        ...
        methods:{
            getCheckInfo(){
                ...
                if( this.reCheckInfo.status==0){
                    ...
                    this.reCheckInfo.content="处理人："+this.checkInfo.handlerName+" "+"处理文章："+this.reCheckInfo.articleTitle+" "+"处理时间："+this.reCheckInfo.handlerTime+" ";
                    this.reCheckInfo.results="处理结果：无"
                }else {
